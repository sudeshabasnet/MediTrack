...
async def run_test():
    ...
    try:
        ...
        # -> Fill in registration form for General User role with valid data and submit.
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError("Test case failed: Registration did not succeed for all roles (Admin, General User, Supplier, Pharmacy) with required fields including pharmacy license details as per the test plan.")
