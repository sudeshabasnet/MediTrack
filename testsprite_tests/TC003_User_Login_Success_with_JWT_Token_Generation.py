...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError('Test case failed: Login did not succeed, JWT token was not returned, or user was not redirected to the role-specific dashboard as expected.')
