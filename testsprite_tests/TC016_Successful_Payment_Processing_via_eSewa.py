...
async def run_test():
    ...
    try:
        ...
        # -> Click on Login to sign in as a user to proceed to checkout for payment testing.
        ...
        # -> Click on Register link to create a new user account for testing payment flow.
        frame = context.pages[-1]
        ...
        # -> Try alternative approach to input Confirm Password, such as clicking the field before typing or ignoring the failed input and proceeding to check terms and submit.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        # Input confirm password after focusing field
        elem = frame.locator('xpath=html/body/div/div[2]/div/div/form/div[4]/div[2]/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('TestPassword123')
        ...
        # -> Fill in Full Name field and correct password and confirm password fields to match, then resubmit the form.
        frame = context.pages[-1]
        # Input Full Name
        ...
        # -> Fill in all required fields in the registration form, agree to terms, and submit the form to create a new user account.
        frame = context.pages[-1]
        # Input Full Name
        elem = frame.locator('xpath=html/body/div/div[2]/div/div/form/div/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('Test User')
        ...
        await page.wait_for_timeout(3000); await elem.fill('123 Test Street, Kathmandu')
        ...
        # -> Click the Register button to submit the form and create the new user account.
        frame = context.pages[-1]
        ...
        # -> Fill in Full Name, Email, Phone Number, Role, Address, Password, Confirm Password fields, check Terms & Conditions, and click Register button to submit the form.
        frame = context.pages[-1]
        # Input Full Name
        elem = frame.locator('xpath=html/body/div/div[2]/div/div/form/div/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('Test User')
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Payment Successful and Order Updated').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test failed: Payment through eSewa gateway was not processed successfully or order status was not updated to paid as per the test plan.")
